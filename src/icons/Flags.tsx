export function FlagUA({ size = 40, ...props }) {
  return (
    <svg
    ...
    >
      <path
        style={{ fill: '#3DAAE0' }}
        d="M324.756,236.842h148.921C473.677,106.032,367.641,0,236.835,0  C302.236,0,324.76,118.425,324.756,236.842z"
      />
      <path
        style={{ fill: '#44C1EF' }}
      ...
      <path
        style={{ fill: '#E8BD1F' }}
        d="M319.771,236.842c0,118.417-17.531,236.835-82.936,236.835  c130.807,0,236.842-106.036,236.842-236.835H319.771z"
      />
      <path
        style={{ fill: '#FDCE0C' }}
        d="M334.935,236.842H0c0,130.799,106.036,236.835,236.835,236.835  C302.236,473.677,334.935,355.26,334.935,236.842z"
      />
    </svg>
  );
}

export function FlagUK({ size = 40, ...props }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
